...
CSV_PATH = f"{DATA_DIR}/{NAME}_manifest.csv"

EMBEDDINGS_PATH = f"{DATA_DIR}/{NAME}_clip_embeddings.npy"
EMBEDDINGS_TARGET_PATH = f"{DATA_DIR}/{NAME}_embeddings.npy"

HF_XL_EMBEDDINGS_TARGET_PATH = f"{DATA_DIR}/hf_xl_{NAME}_embeddings.npy"
